...
import { PaymentAddComponent, PaymentListHead, PaymentListToolbar } from '../sections/@dashboard/payment';
...
const TABLE_HEAD = [
  ...
  { id: 'note', label: 'Əlavə qeyd', alignRight: false },
];
...
export default function Payment() {
  ...
  const getAllSubs = async () => {
    const response = await fetch('https://localhost:7005/api/Payment');
    response.json().then((res) => setPaymentlist(res));
  };
